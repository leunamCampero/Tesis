...
a\mapsto B\left(a\right)$ representaciones de $G$. Si existe una
...
\begin{equation*}
  \begin{pmatrix}
    \chi_{1}(a_{1}) & . & \chi_{1}(a_{k}) \\ 
    . & ... & . \\
    \chi_{l}(a_{1}) & . & \chi_{l}(a_{k})
  \end{pmatrix}
  \begin{pmatrix}
    h_{1} \overline{\chi_{1}(a_{1})} & . & h_{1} \overline{\chi_{l}(a_{1})} \\ 
    . & ... & . \\
    h_{k} \overline{\chi_{1}(a_{k})} & . & h_{k} \overline{\chi_{l}(a_{k})}  
  \end{pmatrix},
\end{equation*}
\begin{equation*}
  =
...
\begin{equation*}
  \begin{pmatrix}
    \chi_{1}(a_{1}) & . & \chi_{l}(a_{1}) \\ 
    . & ... & . \\
    \chi_{l}(a_{k}) & . & \chi_{l}(a_{k})
  \end{pmatrix}
  \begin{pmatrix}
     \overline{\chi_{1}(a_{1})} & . &  \overline{\chi_{l}(a_{1})} \\ 
    . & ... & . \\
     \overline{\chi_{1}(a_{k})} & . &  \overline{\chi_{l}(a_{k})}  
  \end{pmatrix},
\end{equation*}
...
Sea $G$ un grupo de orden $g$ y $H$ un subgrupo de $G$ de orden $h$. Para una función $\psi$ en $G$, $\psi_{H}$ denota la restricción de $\psi$ a $H$.
