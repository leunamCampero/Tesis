...
\begin{example}
  ...
  \begin{equation*}
    ...
    \right.
  \end{equation*}
  entonces definimos $A\left(\sigma\right)$ como la matriz cuyo $i$-ésimo renglón es
  $\left(0,...,0,1,0,...,0\right)$ con 1 en el $s_{i}$-ésimo lugar,
  entonces para $\left(i,j=1,2,...,n\right)$, por lo cual
  \begin{equation*}
...
\begin{example}
  ...
  homomorfismo inyectivo de $G$ a $S^{G}$.
  \begin{equation}
    \label{eq:6}
    \begin{pmatrix}
  ...
  \begin{equation*}
    ...
    \right.
  \end{equation*}
  se tiene la siguiente matriz, y se observa que si $a \neq 1$,
  entonces cada elemento sobre la diagonal es cero.
  \begin{equation}
    \label{eq:7}
    A\left(a\right) = 
    \begin{pmatrix}
