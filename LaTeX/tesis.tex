...
$H_k(\Delta(K(G_7)))$ y $H_k(\Delta(K(G_7)))$ para algunos $k \geq 0$,
los cuales son los resultados obtenidos en el programa hecho en Python
que se puede ser hallado en...
...
A cada complejo simplicial $\Delta$ se le puede asociar su realización
...
Similarmente el programa permitió observar que $\widetilde H_{k}(M_{7})\cong_{S_7} \widetilde H_{k}(K(M_{7}))$ para $k\geq0$, donde la única homología no trivial es:
...
computadora fue insuficiente gracias a la cantidad de los $2'$s y
$3'$s-simplejos, por ello sólo fue factible verificar que:
\begin{equation}
